...
export default function Footer() {
  return (
    <footer className="w-full bg-[#161931] text-white">
      <div className="max-w-[1499px] mx-auto px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <form className="flex flex-col space-y-2">
              <input
                ...
                className="px-4 py-2 bg-white text-black rounded focus:outline-none focus:ring-2 focus:ring-primary"
              />
              <button
                type="submit"
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/club" className="text-gray-300 hover:text-white transition-colors">
                  Club
                </Link>
              </li>
              <li>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="text-sm text-gray-400">
              <p>&copy; {new Date().getFullYear()} Mekatrone. All rights reserved.</p>
            </div>
